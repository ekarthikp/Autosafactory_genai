...
Uses APIIndex-backed knowledge for accurate code generation:
- Runtime introspection of autosarfactory (api_index.py)
- Consolidated hallucination fixes (api_fixes.py)
- Compact, token-efficient prompts (generator.py)
- Pre-generation validation (validation_engine.py)
